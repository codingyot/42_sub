...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/04/24 16:53:48 by oallan            #+#    #+#             */
/*   Updated: 2024/04/24 17:10:19 by oallan           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_sort_b_till_3(t_stack **stack_a, t_stack **stack_b)
{
	...
	while (ft_lst_size(*stack_a) > 3 && !ft_check_sorted(*stack_a))
	{
		tmp = *stack_a;
...
t_stack	*ft_sort_b(t_stack **stack_a)
{
	...
	stack_b = NULL;
	if (ft_lst_size(*stack_a) > 3 && !ft_check_sorted(*stack_a))
